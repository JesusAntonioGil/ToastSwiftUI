...
enum ToastType: String, Hashable, CaseIterable {
    ...
    var title: String {
        switch self {
            case .info: "Info toast message"
            case .success: "Success toast message"
            case .error: "Error toast message"
            case .warning: "Warning toast message"
        }
    }
    
    var description: String {
        switch self {
            case .info: "Info description"
            case .success: "Success description"
